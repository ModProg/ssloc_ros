...
pub mod ssloc_ros_msgs {
    ...
    impl std::convert::From<UnitSsl> for rosrust::MsgValue {
        fn from(src: UnitSsl) -> Self {
            rosrust::MsgValue::Message(src.into())
        }
    }
    impl std::convert::From<UnitSsl> for rosrust::MsgMessage {
        fn from(src: UnitSsl) -> Self {
            let mut output = Self::new();
            output.insert("x".into(), src.x.into());
            output.insert("y".into(), src.y.into());
    ...
    impl std::convert::TryFrom<rosrust::MsgValue> for UnitSsl {
        type Error = ();
    ...
    impl std::convert::TryFrom<rosrust::MsgMessage> for UnitSsl {
        type Error = ();
    ...
    impl std::cmp::PartialEq<Self> for UnitSsl {
        fn eq(&self, other: &Self) -> bool {
            true && self.x == other.x && self.y == other.y && self.z == other.z && self.E == other.E
        }
    }
    impl std::fmt::Debug for UnitSsl {
        fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
            f.debug_struct(stringify!(UnitSsl))
                .field(stringify!(x), &self.x)
                .field(stringify!(y), &self.y)
                .field(stringify!(z), &self.z)
                .field(stringify!(E), &self.E)
    ...
    impl rosrust::Message for UnitSsl {
        #[inline]
        fn msg_definition() -> ::std::string::String {
            "# A single SSL on the unit sphere\nfloat64 x\nfloat64 y\nfloat64 z\nfloat64 E\n".into()
        }
        ...
        #[inline]
        fn msg_type() -> ::std::string::String {
            "ssloc_ros_msgs/UnitSsl".into()
        }
    }
    impl rosrust::rosmsg::RosMsg for UnitSsl {
        fn encode<W: ::std::io::Write>(&self, mut w: W) -> ::std::io::Result<()> {
            self.x.encode(w.by_ref())?;
            self.y.encode(w.by_ref())?;
            self.z.encode(w.by_ref())?;
    ...
    #[allow(dead_code, non_camel_case_types, non_snake_case)]
    #[derive(Clone)]
    pub struct UnitSstArray {
        pub header: super::std_msgs::Header,
        pub sources: Vec<super::ssloc_ros_msgs::UnitSst>,
    }
    impl UnitSstArray {}

    impl std::convert::From<UnitSstArray> for rosrust::MsgValue {
        fn from(src: UnitSstArray) -> Self {
            rosrust::MsgValue::Message(src.into())
        }
    }
    impl std::convert::From<UnitSstArray> for rosrust::MsgMessage {
        fn from(src: UnitSstArray) -> Self {
            let mut output = Self::new();
            output.insert("header".into(), src.header.into());
            output.insert("sources".into(), src.sources.into());
    ...
    impl std::convert::TryFrom<rosrust::MsgValue> for UnitSstArray {
        type Error = ();
    ...
    impl std::convert::TryFrom<rosrust::MsgMessage> for UnitSstArray {
        type Error = ();
    ...
    impl std::cmp::PartialEq<Self> for UnitSstArray {
        fn eq(&self, other: &Self) -> bool {
            true && self.header == other.header && self.sources == other.sources
        }
    }
    impl std::fmt::Debug for UnitSstArray {
        fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
            f.debug_struct(stringify!(UnitSstArray))
                .field(stringify!(header), &self.header)
                .field(stringify!(sources), &self.sources)
                .finish()
        }
    }
    impl Default for UnitSstArray {
        fn default() -> Self {
            Self {
                header: Default::default(),
                sources: Default::default(),
    ...
    impl rosrust::Message for UnitSstArray {
        #[inline]
        fn msg_definition() -> ::std::string::String {
            "Header header\nssloc_ros_msgs/UnitSst[] sources\n\n================================================================================\nMSG: std_msgs/Header\n# Standard metadata for higher-level stamped data types.\n# This is generally used to communicate timestamped data \n# in a particular coordinate frame.\n# \n# sequence ID: consecutively increasing ID \nuint32 seq\n#Two-integer timestamp that is expressed as:\n# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')\n# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')\n# time-handling sugar is provided by the client library\ntime stamp\n#Frame this data is associated with\nstring frame_id\n\n================================================================================\nMSG: ssloc_ros_msgs/UnitSst\nint64 id\nfloat64 x\nfloat64 y\nfloat64 z\nfloat64 activity\n".into()
        }
        ...
        #[inline]
        fn msg_type() -> ::std::string::String {
            "ssloc_ros_msgs/UnitSstArray".into()
        }
    ...
    impl rosrust::rosmsg::RosMsg for UnitSstArray {
        fn encode<W: ::std::io::Write>(&self, mut w: W) -> ::std::io::Result<()> {
            self.header.encode(w.by_ref())?;
            rosrust::rosmsg::encode_variable_slice(&self.sources, w.by_ref())?;
            Ok(())
    ...
    #[allow(dead_code, non_camel_case_types, non_snake_case)]
    #[derive(Clone)]
    pub struct UnitSslArray {
        pub header: super::std_msgs::Header,
        pub sources: Vec<super::ssloc_ros_msgs::UnitSsl>,
    }
    impl UnitSslArray {}

    impl std::convert::From<UnitSslArray> for rosrust::MsgValue {
        fn from(src: UnitSslArray) -> Self {
            rosrust::MsgValue::Message(src.into())
        }
    }
    impl std::convert::From<UnitSslArray> for rosrust::MsgMessage {
        fn from(src: UnitSslArray) -> Self {
            let mut output = Self::new();
            output.insert("header".into(), src.header.into());
            output.insert("sources".into(), src.sources.into());
    ...
    impl std::convert::TryFrom<rosrust::MsgValue> for UnitSslArray {
        type Error = ();
    ...
    impl std::convert::TryFrom<rosrust::MsgMessage> for UnitSslArray {
        type Error = ();
    ...
    impl std::cmp::PartialEq<Self> for UnitSslArray {
        fn eq(&self, other: &Self) -> bool {
            true && self.header == other.header && self.sources == other.sources
        }
    }
    impl std::fmt::Debug for UnitSslArray {
        fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
            f.debug_struct(stringify!(UnitSslArray))
                .field(stringify!(header), &self.header)
                .field(stringify!(sources), &self.sources)
                .finish()
        }
    }
    impl Default for UnitSslArray {
        fn default() -> Self {
            Self {
                header: Default::default(),
                sources: Default::default(),
    ...
    impl rosrust::Message for UnitSslArray {
        #[inline]
        fn msg_definition() -> ::std::string::String {
            "# A list of SSLs on the unit sphere\nHeader header\nssloc_ros_msgs/UnitSsl[] sources\n\n================================================================================\nMSG: std_msgs/Header\n# Standard metadata for higher-level stamped data types.\n# This is generally used to communicate timestamped data \n# in a particular coordinate frame.\n# \n# sequence ID: consecutively increasing ID \nuint32 seq\n#Two-integer timestamp that is expressed as:\n# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')\n# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')\n# time-handling sugar is provided by the client library\ntime stamp\n#Frame this data is associated with\nstring frame_id\n\n================================================================================\nMSG: ssloc_ros_msgs/UnitSsl\n# A single SSL on the unit sphere\nfloat64 x\nfloat64 y\nfloat64 z\nfloat64 E\n".into()
        }
        ...
        #[inline]
        fn msg_type() -> ::std::string::String {
            "ssloc_ros_msgs/UnitSslArray".into()
        }
    ...
    impl rosrust::rosmsg::RosMsg for UnitSslArray {
        fn encode<W: ::std::io::Write>(&self, mut w: W) -> ::std::io::Result<()> {
            self.header.encode(w.by_ref())?;
            rosrust::rosmsg::encode_variable_slice(&self.sources, w.by_ref())?;
            Ok(())
    ...
    impl std::convert::From<UnitSst> for rosrust::MsgValue {
        fn from(src: UnitSst) -> Self {
            rosrust::MsgValue::Message(src.into())
        }
    }
    impl std::convert::From<UnitSst> for rosrust::MsgMessage {
        fn from(src: UnitSst) -> Self {
            let mut output = Self::new();
            output.insert("id".into(), src.id.into());
            output.insert("x".into(), src.x.into());
    ...
    impl std::convert::TryFrom<rosrust::MsgValue> for UnitSst {
        type Error = ();
    ...
    impl std::convert::TryFrom<rosrust::MsgMessage> for UnitSst {
        type Error = ();
    ...
    impl std::cmp::PartialEq<Self> for UnitSst {
        fn eq(&self, other: &Self) -> bool {
            true && self.id == other.id
                && self.x == other.x
                && self.y == other.y
    ...
    impl std::fmt::Debug for UnitSst {
        fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
            f.debug_struct(stringify!(UnitSst))
                .field(stringify!(id), &self.id)
                .field(stringify!(x), &self.x)
                .field(stringify!(y), &self.y)
                .field(stringify!(z), &self.z)
    ...
    impl rosrust::Message for UnitSst {
        #[inline]
        fn msg_definition() -> ::std::string::String {
            "int64 id\nfloat64 x\nfloat64 y\nfloat64 z\nfloat64 activity\n".into()
        }
        ...
        #[inline]
        fn msg_type() -> ::std::string::String {
            "ssloc_ros_msgs/UnitSst".into()
        }
    }
    impl rosrust::rosmsg::RosMsg for UnitSst {
        fn encode<W: ::std::io::Write>(&self, mut w: W) -> ::std::io::Result<()> {
            self.id.encode(w.by_ref())?;
            self.x.encode(w.by_ref())?;
            self.y.encode(w.by_ref())?;
